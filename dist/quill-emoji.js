...
/* harmony import */ var _src_quill_emoji_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src/quill-emoji.js */ "./src/quill-emoji.js");
/* harmony import */ var _src_quill_emoji_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_src_quill_emoji_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _src_scss_quill_emoji_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./src/scss/quill-emoji.scss */ "./src/scss/quill-emoji.scss");
/* harmony import */ var _src_scss_quill_emoji_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_src_scss_quill_emoji_scss__WEBPACK_IMPORTED_MODULE_1__);
    ...
    _createClass(EmojiBlot, [{
        ...
        value: function create(value) {
            ...
            if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object') {
                ...
                var dataUrl = 'data:image/png;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=';
...
var _emojiList = __webpack_require__(/*! ./emoji-list.js */ "./src/emoji-list.js");
...
var ShortNameEmoji = function (_Module) {
  _inherits(ShortNameEmoji, _Module);

  function ShortNameEmoji(quill, options) {
    _classCallCheck(this, ShortNameEmoji);

    var _this2 = _possibleConstructorReturn(this, (ShortNameEmoji.__proto__ || Object.getPrototypeOf(ShortNameEmoji)).call(this, quill, options));

    _this2.emojiList = options.emojiList;
    _this2.fuse = new _fuse2.default(options.emojiList, options.fuse);

    _this2.quill = quill;
    _this2.onClose = options.onClose;
    _this2.onOpen = options.onOpen;
    _this2.container = document.createElement('ul');
    _this2.container.classList.add('emoji_completions');
    _this2.quill.container.appendChild(_this2.container);
    _this2.container.style.position = "absolute";
    _this2.container.style.display = "none";

    _this2.onSelectionChange = _this2.maybeUnfocus.bind(_this2);
    _this2.onTextChange = _this2.update.bind(_this2);

    _this2.open = false;
    _this2.atIndex = null;
    _this2.focusedButton = null;

    _this2.isWhiteSpace = function (ch) {
    ...
    quill.keyboard.addBinding({
      ...
      shiftKey: true
    }, _this2.triggerPicker.bind(_this2));
    ...
    }, _this2.handleArrow.bind(_this2));
  ...
  _createClass(ShortNameEmoji, [{
    ...
    value: function triggerPicker(range, context) {
      ...
      if (range.length > 0) this.quill.deleteText(range.index, range.length, _quill2.default.sources.USER);

      this.quill.insertText(range.index, ":", "emoji-shortname", _quill2.default.sources.USER);
    ...
    value: function renderCompletions(emojis) {
      ...
      var handler = function handler(i, emoji, _this) {
        var event = this;
      ...
      emojis.forEach(function (emoji, i) {
        var li = makeElement('li', {}, makeElement('button', { type: "button" }, makeElement("span", { className: "emoji ap ap-" + emoji.name, innerHTML: emoji.code_decimal }),
        ...
        buttons[i].addEventListener("focus", function () {
          self.focusedButton = i;
        });
        buttons[i].addEventListener("unfocus", function () {
          self.focusedButton = null;
        });
      });
    ...
    value: function enterEmoji(value) {
      if (value) {
        ...
        var emoji_icon_html = makeElement("span", { className: "ico", innerHTML: ' ' + code_decimal + ' ' });
        ...
        ops = ops.concat([{ delete: this.query.length + 1 }, {
...
var TextAreaEmoji = function (_Module) {
    _inherits(TextAreaEmoji, _Module);

    function TextAreaEmoji(quill, options) {
        _classCallCheck(this, TextAreaEmoji);

        var _this = _possibleConstructorReturn(this, (TextAreaEmoji.__proto__ || Object.getPrototypeOf(TextAreaEmoji)).call(this, quill, options));
    ...
    _createClass(TextAreaEmoji, [{
        ...
        value: function checkEmojiBoxExist() {
            ...
            if (elementExists) {
                ...
                var emojiType = [{ 'type': 'p', 'name': 'people', 'content': '<div class="ap ap-smiley"></div>' }, { 'type': 'n', 'name': 'nature', 'content': '<div class="ap ap-herb"></div>' }, { 'type': 'd', 'name': 'food', 'content': '<div class="ap ap-birthday"></div>' }, { 'type': 's', 'name': 'symbols', 'content': '<div class="ap ap-heart"></div>' }, { 'type': 'a', 'name': 'activity', 'content': '<div class="ap ap-soccer"></div>' }, { 'type': 't', 'name': 'travel', 'content': '<div class="ap ap-airplane"></div>' }, { 'type': 'o', 'name': 'objects', 'content': '<div class="ap ap-bulb"></div>' }, { 'type': 'f', 'name': 'flags', 'content': '<div class="ap ap-flag-sg"></div>' }];
...
function fn_emojiElementsToPanel(type, panel, quill) {
    ...
    var fuse = new _fuse2.default(_emojiList2.default, fuseOptions);
...
var ToolbarEmoji = function (_Module) {
  _inherits(ToolbarEmoji, _Module);

  function ToolbarEmoji(quill, options) {
    _classCallCheck(this, ToolbarEmoji);

    var _this = _possibleConstructorReturn(this, (ToolbarEmoji.__proto__ || Object.getPrototypeOf(ToolbarEmoji)).call(this, quill, options));
...
function fn_showEmojiPalatte(quill) {
  ...
  var emojiType = [{ 'type': 'p', 'name': 'people', 'content': '<div class="i-people"></div>' }, { 'type': 'n', 'name': 'nature', 'content': '<div class="i-nature"></div>' }, { 'type': 'd', 'name': 'food', 'content': '<div class="i-food"></div>' }, { 'type': 's', 'name': 'symbols', 'content': '<div class="i-symbols"></div>' }, { 'type': 'a', 'name': 'activity', 'content': '<div class="i-activity"></div>' }, { 'type': 't', 'name': 'travel', 'content': '<div class="i-travel"></div>' }, { 'type': 'o', 'name': 'objects', 'content': '<div class="i-objects"></div>' }, { 'type': 'f', 'name': 'flags', 'content': '<div class="i-flags"></div>' }];
...
function fn_emojiElementsToPanel(type, panel, quill) {
  ...
  result.map(function (emoji) {
    ...
    if (customButton) {
      customButton.addEventListener('click', function () {
        var emoji_icon_html = makeElement("span", { className: "ico", innerHTML: '' + emoji.code_decimal + ' ' });
        var emoji_icon = emoji_icon_html.innerHTML;
        quill.insertEmbed(range.index, 'emoji', emoji);
        fn_close();
      });
...
var _formatEmojiBlot = __webpack_require__(/*! ./format-emoji-blot */ "./src/format-emoji-blot.js");

var _formatEmojiBlot2 = _interopRequireDefault(_formatEmojiBlot);

var _moduleEmoji = __webpack_require__(/*! ./module-emoji */ "./src/module-emoji.js");

var _moduleEmoji2 = _interopRequireDefault(_moduleEmoji);

var _moduleToolbarEmoji = __webpack_require__(/*! ./module-toolbar-emoji */ "./src/module-toolbar-emoji.js");

var _moduleToolbarEmoji2 = _interopRequireDefault(_moduleToolbarEmoji);

var _moduleTextareaEmoji = __webpack_require__(/*! ./module-textarea-emoji */ "./src/module-textarea-emoji.js");

var _moduleTextareaEmoji2 = _interopRequireDefault(_moduleTextareaEmoji);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_quill2.default.register({
  'formats/emoji': _formatEmojiBlot2.default,
  'modules/emoji-shortname': _moduleEmoji2.default,
  'modules/emoji-toolbar': _moduleToolbarEmoji2.default,
  'modules/emoji-textarea': _moduleTextareaEmoji2.default
}, true);

exports.default = { EmojiBlot: _formatEmojiBlot2.default, ShortNameEmoji: _moduleEmoji2.default, ToolbarEmoji: _moduleToolbarEmoji2.default, TextAreaEmoji: _moduleTextareaEmoji2.default };
